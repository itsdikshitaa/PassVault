...
function EmptyStateSection({ onGeneratePassword }: { onGeneratePassword: () => void }) {
  return (
    <div className="relative overflow-hidden border border-border bg-card/92 px-6 py-10 sm:px-10 sm:py-14">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-primary/45 to-transparent" />
        <div className="absolute right-6 top-6 h-18 w-18 border border-primary/15 sm:h-24 sm:w-24" />
      </div>

      <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1fr)_18rem] lg:items-end">
        <div className="space-y-6">
          <Badge variant="outline">Vault ready</Badge>
          <div className="space-y-3">
            <h3 className="max-w-2xl font-serif text-[clamp(2.7rem,6vw,4.8rem)] font-semibold leading-[0.94] tracking-[-0.06em] text-balance">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button onClick={onGeneratePassword} size="lg" className="h-14 px-6 text-base">
              <Sparkles className="mr-2 h-5 w-5" />
              Generate a password
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <div className="inline-flex items-center gap-3 border border-border bg-background/78 px-4 py-3 text-sm text-muted-foreground">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
          <div className="border border-border bg-background/78 p-5">
            <div className="mb-2 text-[0.7rem] font-semibold uppercase tracking-[0.26em] text-muted-foreground">Local-first</div>
          ...
          <div className="border border-border bg-background/78 p-5">
            <div className="mb-2 text-[0.7rem] font-semibold uppercase tracking-[0.26em] text-muted-foreground">Organized later</div>
...
export function PasswordDashboard({ onClose }: PasswordDashboardProps) {
  ...
  const getStrengthLabel = (strength: number) => {
    if (strength < 30) return { label: "Weak", color: "border-red-500/30 bg-red-500/12 text-red-700 dark:text-red-300", textColor: "text-red-700 dark:text-red-300" }
    if (strength < 60) return { label: "Fair", color: "border-amber-500/30 bg-amber-500/14 text-amber-700 dark:text-amber-300", textColor: "text-amber-700 dark:text-amber-300" }
    if (strength < 80) return { label: "Good", color: "border-secondary/30 bg-secondary/16 text-secondary dark:text-[color:oklch(0.82_0.03_246)]", textColor: "text-secondary dark:text-[color:oklch(0.82_0.03_246)]" }
    return { label: "Strong", color: "border-primary/30 bg-primary/14 text-primary dark:text-[color:oklch(0.8_0.08_45)]", textColor: "text-primary dark:text-[color:oklch(0.8_0.08_45)]" }
  }
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-x-0 top-0 h-[24rem] bg-[radial-gradient(circle_at_top_left,rgba(80,95,145,0.14),transparent_36%),radial-gradient(circle_at_top_right,rgba(162,92,54,0.16),transparent_40%)]" />
        <div className="absolute left-[-5rem] top-24 h-52 w-52 border border-primary/14" />
        <div className="absolute right-[-6rem] top-20 h-72 w-72 rounded-full bg-primary/8 blur-3xl" />
      </div>
      ...
      <div className="relative z-10">
        <div className="sticky top-0 z-30 border-b border-border bg-background/90 backdrop-blur-xl">
          <div className="mx-auto max-w-7xl px-4 pb-4 pt-4 sm:px-6 sm:pb-5 sm:pt-5">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div className="space-y-3">
                <div className="flex flex-wrap items-center gap-2">
                  <Badge variant="outline">Vault workspace</Badge>
                  <Badge variant="outline">{stats.total} saved</Badge>
                  <Badge variant="outline">{securityScore}% secure</Badge>
                </div>
                <div className="space-y-2">
                  <h2 className="font-serif text-[clamp(2.4rem,5vw,4.2rem)] font-semibold leading-[0.94] tracking-[-0.06em]">
                    Password dashboard
                  </h2>
              ...
              <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="vault-sheet p-4">
                        <div className="space-y-3">
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center justify-between gap-4 border border-border bg-background/84 px-4 py-3">
                              <div>
                      ...
                      {!exportOptions.includePasswords && (
                        <div className="border border-amber-500/30 bg-amber-500/8 px-4 py-3 text-sm text-amber-700 dark:text-amber-300">
                ...
                <Button variant="outline" onClick={onClose} className="h-11 px-4">
        ...
        <div className="mx-auto max-w-7xl px-4 pb-10 pt-6 sm:px-6 sm:pt-8">
          <Tabs defaultValue="overview" className="space-y-8">
            <div className="sticky top-[7.3rem] z-20 pb-1">
              <div className="border border-border bg-background/90 p-2 shadow-[0_24px_60px_-40px_rgba(40,27,20,0.34)] backdrop-blur-xl">
              ...
              {stats.total === 0 ? (
                ...
                <>
                  <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
                    <Card className="border-border bg-background/84">
                    ...
                    <Card className="border-red-500/20 bg-background/84">
                      <CardContent className="p-5">
                    ...
                    <Card className="border-amber-500/20 bg-background/84">
                      <CardContent className="p-5">
                    ...
                    <Card className="border-secondary/20 bg-background/84">
                      <CardContent className="p-5">
                        <div className="mb-4 flex items-center gap-2 text-secondary dark:text-[color:oklch(0.82_0.03_246)]">
                        ...
                        <div className="text-4xl font-semibold tracking-tight text-secondary dark:text-[color:oklch(0.82_0.03_246)]">{stats.good}</div>
                      </CardContent>
                    </Card>
                      ...
                      <CardContent>
                        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                          {Object.entries(categoryStats).map(([categoryName, categoryStat]) => (
                            <div
                              key={categoryName}
                            className="vault-sheet p-4 transition-[transform,box-shadow,border-color,background-color] duration-200 hover:-translate-y-0.5 hover:border-primary/20 hover:shadow-lg hover:shadow-primary/8"
                            >
                              <div className="mb-3 flex items-start justify-between gap-3">
                                <div className="flex items-center gap-3">
                                  <div className="flex h-11 w-11 items-center justify-center border border-border bg-background/88 text-lg">
                              ...
                              <div className="mt-3 grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                                <span className="border border-border bg-background/80 px-3 py-1 text-primary dark:text-[color:oklch(0.8_0.08_45)]">
                                  Strong {categoryStat.strong}
                                </span>
                                <span className="border border-border bg-background/80 px-3 py-1 text-secondary dark:text-[color:oklch(0.82_0.03_246)]">
                                  Good {categoryStat.good}
                                </span>
                                <span className="border border-border bg-background/80 px-3 py-1 text-amber-700 dark:text-amber-300">
                                  Fair {categoryStat.fair}
                                </span>
                                <span className="border border-border bg-background/80 px-3 py-1 text-red-700 dark:text-red-300">
                    ...
                    <Card className="vault-frame">
                      ...
                      <CardContent className="space-y-3">
                        {passwords.slice(0, 5).map((password) => (
                          <div
                            key={password.id}
                            className="vault-sheet p-4 transition-[transform,box-shadow,border-color,background-color] duration-200 hover:-translate-y-0.5 hover:border-primary/20 hover:shadow-md"
                          >
                            <div className="mb-3 flex items-start justify-between gap-3">
                              ...
                              <Badge variant="outline" className={getStrengthLabel(password.strength).color}>
            ...
            <TabsContent value="passwords" className="space-y-6">
              ...
              {selectedPasswords.length > 0 && (
                <div className="flex flex-col gap-3 border border-primary/18 bg-primary/8 p-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {filteredAndSortedPasswords.map((password) => (
                      <div
                        key={password.id}
                        className="grid gap-4 border border-border bg-background/84 p-4 transition-[transform,box-shadow,border-color,background-color] duration-200 hover:-translate-y-0.5 hover:border-primary/20 hover:shadow-lg hover:shadow-primary/8 lg:grid-cols-[auto_minmax(0,1fr)_auto]"
                      >
                        <div className="pt-1">
                          <Checkbox
                          ...
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            {password.category ? (
                              ...
                              >
                                ...
                                <Badge variant="outline" className="border-border bg-background/76 text-muted-foreground">
                                  No category
                                </Badge>
                            )}
                          </div>
                    ...
                    {filteredAndSortedPasswords.length === 0 && (
                        <div className="border border-dashed border-border bg-background/76 px-6 py-12 text-center">
              ...
              {categories.length === 0 ? (
                <Card className="vault-frame">
                  <CardContent className="p-8 sm:p-12">
                    <div className="mx-auto max-w-2xl text-center">
                      <div className="mx-auto mb-6 flex h-18 w-18 items-center justify-center border border-border bg-background/84 text-primary">
                      ...
                      <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
                        <Button onClick={handleGeneratePassword} variant="outline" className="h-12 px-5">
                          <Sparkles className="mr-2 h-4 w-4" />
                          Generate first
                        </Button>
                        <Dialog open={showCategoryDialog} onOpenChange={setShowCategoryDialog}>
                          <DialogTrigger asChild>
                            <Button onClick={openAddCategory} className="h-12 px-5">
                ...
                <Card className="vault-frame">
                  <CardHeader className="gap-4 sm:flex-row sm:items-end sm:justify-between">
                    ...
                    <Dialog open={showCategoryDialog} onOpenChange={setShowCategoryDialog}>
                      <DialogTrigger asChild>
                        <Button onClick={openAddCategory} className="h-11 px-5">
                          <Plus className="mr-2 h-4 w-4" />
                          Add category
                        </Button>
                      </DialogTrigger>
                  ...
                  <CardContent>
                    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                      {categories.map((category) => (
                        <Card key={category.id} className="border-border bg-background/84 p-6">
                    ...
                    <CardContent className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_21rem]">
                      <div className="vault-sheet p-5">
                        ...
                        <div className="mt-4 grid gap-3 sm:grid-cols-2">
                          <div className="border border-border bg-background/80 px-4 py-3 text-sm">
                            <div className="text-muted-foreground">Strong</div>
                            <div className="mt-1 font-medium text-primary dark:text-[color:oklch(0.8_0.08_45)]">
                              {stats.strong} ({stats.total > 0 ? Math.round((stats.strong / stats.total) * 100) : 0}%)
                            </div>
                          </div>
                          <div className="border border-border bg-background/80 px-4 py-3 text-sm">
                            <div className="text-muted-foreground">Good</div>
                            <div className="mt-1 font-medium text-secondary dark:text-[color:oklch(0.82_0.03_246)]">
                        ...
                        <div className="vault-sheet p-4">
                          ...
                          <div className="space-y-3 text-sm leading-6">
                            ...
                            {stats.strong > stats.total * 0.8 && (
                              <div className="flex items-start gap-2 text-primary dark:text-[color:oklch(0.8_0.08_45)]">
