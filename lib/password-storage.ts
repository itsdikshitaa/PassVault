...
export const DEFAULT_CATEGORY_COLOR = "#8a4931"

export const DEFAULT_CATEGORIES: Omit<Category, "id" | "createdAt">[] = [
  { name: "Personal", color: "#8a4931", icon: "\u{1F464}" },
  { name: "Work", color: "#54688f", icon: "\u{1F4BC}" },
  { name: "Social", color: "#6f5b8f", icon: "\u{1F310}" },
  { name: "Banking", color: "#d59a2a", icon: "\u{1F3E6}" },
  { name: "Shopping", color: "#b84232", icon: "\u{1F6D2}" },
  { name: "Entertainment", color: "#8f5a63", icon: "\u{1F3AC}" },
]
